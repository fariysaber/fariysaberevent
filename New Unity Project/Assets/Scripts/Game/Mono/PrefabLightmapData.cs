...
public class PrefabLightmapData : MonoBehaviour
{
    ...
    static void GetRefreshGameObject()
    {
        GameObject ground = GameObject.Find("ground");
        int layer = ground.layer;
        SetStaticAndLayer(ground, layer);
    }

    static void SetStaticAndLayer(GameObject go,int layer)
    {
        Transform[] form = go.GetComponentsInChildren<Transform>(true);
